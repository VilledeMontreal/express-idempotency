...
export class IdempotencyService {
  ...
  constructor(options: IdempotencyOptions = {}) {
    ...
    this._options = {
      idempotencyKeyHeader: options.idempotencyKeyHeader ?? IDEMPOTENCY_KEY_HEADER,
      dataAdapter: options.dataAdapter ?? new InMemoryDataAdapter(),
      responseValidator: options.responseValidator ?? new SuccessfulResponseValidator(),
      intentValidator: options.intentValidator ?? new DefaultIntentValidator(),
    };
  }
